    ...
    withCredentials([string(credentialsId: 'veracode-api-id', variable: 'VERACODE_API_ID'),
        ...
        if (isUnix()) {
            sh '''
                ...
                # by design: with webhook-triggered builds, two pushes close
                # together can produce overlapping scans on the same app
                # profile, and we do not want one build silently deleting
